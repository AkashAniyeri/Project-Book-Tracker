...
(3, 'Michael Johnson', 'Librarian', 45000.00, 3),
(4, 'Emily Brown', 'Clerk', 35000.00, 1),
(5, 'David Lee', 'Clerk', 38000.00, 2),
(6, 'Sarah Clark', 'Assistant Librarian', 42000.00, 3);
...
(1001, 'Introduction to SQL', 'Computer Science', 20.00, 'yes', 'John Smith', 'Tech Books Inc.'),
...
(1, 'Alice Brown', '456 Pine St', '2021-12-15'),
(2, 'Bob Green', '789 Cedar St', '2023-02-28'),
(3, 'Eve Jones', '901 Maple St', '2020-10-20'),
(4, 'Tom White', '234 Walnut St', '2022-05-05'),
(5, 'Emma Lee', '567 Birch St', '2023-04-10');
...
SELECT DISTINCT c.Customer_name FROM IssueStatus i JOIN Books b ON i.Isbn_book = b.ISBN JOIN Customer c ON i.Issued_cust = c.Customer_Id WHERE b.Rental_Price > 25;
